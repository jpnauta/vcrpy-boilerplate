...
class GoogleSimulator(BaseSimulator):
    def simulate_home_page(self, factory: SimulationFactory):
        ...
        # - If re-playing cassettes, it will load `fixtures/cassettes/google/home_page.yaml`
        # - If recording cassettes, it will record any requests in `fixtures/cassettes/google/home_page.yaml`
